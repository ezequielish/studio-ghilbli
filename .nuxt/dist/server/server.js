...
/******/ 			var chunk = require("./" + ({"1":"pages/Login","2":"pages/Register","3":"pages/User","4":"pages/index","5":"pages/movie/_id"}[chunkId]||chunkId) + ".js");
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SET_ALL_FILMS", function() { return SET_ALL_FILMS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FILMS_LOADING", function() { return FILMS_LOADING; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FILMS_ERROR", function() { return FILMS_ERROR; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LIKE_MOVIE", function() { return LIKE_MOVIE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "INPUT_SEARCH", function() { return INPUT_SEARCH; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ERROR_COMMETS", function() { return ERROR_COMMETS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LOADING_COMMETS", function() { return LOADING_COMMETS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LOADING_COMMETS_DELETE", function() { return LOADING_COMMETS_DELETE; });
...
const ERROR_COMMETS = "ERROR_COMMETS";
const LOADING_COMMETS = "LOADING_COMMETS";
const LOADING_COMMETS_DELETE = "LOADING_COMMETS_DELETE";
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ERROR_LOGIN", function() { return ERROR_LOGIN; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LOGOUT_AUTH", function() { return LOGOUT_AUTH; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _types_fimlsTypes__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);

const URL_ALL_MOVIES = "https://ghibliapi.herokuapp.com/films/";
const URL_COMMENTS_FILM = "https://studio-ghilbli-api-production.up.railway.app/api" + "/comment";
...
const store = {
  ...
  actions: {
    async deleteComment({
      ...
      try {
        ...
        if (dataJson.error) {
          ...
          commit(_types_fimlsTypes__WEBPACK_IMPORTED_MODULE_0__["SET_ALL_FILMS"], state.films);
          return dataJson;
        }
      } catch (error) {
        commit(_types_fimlsTypes__WEBPACK_IMPORTED_MODULE_0__["ERROR_COMMETS"], error || ERROR_DEFAULT);
      }
    },
    async getAllFilmsApi({
      commit
    }) {
      commit(_types_fimlsTypes__WEBPACK_IMPORTED_MODULE_0__["FILMS_LOADING"], true);
      try {
        ...
        commit(_types_fimlsTypes__WEBPACK_IMPORTED_MODULE_0__["SET_ALL_FILMS"], nData);
      } catch (error) {
        // console.log(error);
        commit(_types_fimlsTypes__WEBPACK_IMPORTED_MODULE_0__["FILMS_ERROR"], error || ERROR_DEFAULT);
      }
    },
    async addComment({
      commit,
      ...
      try {
        ...
        if (dataJson.error) {
          ...
          const filmSelected = state.films[indexFilmSelected];
          const comments = [...filmSelected.comments];
          const newComments = [...comments, dataJson.data];
          oldFilms[indexFilmSelected].comments = newComments;
          commit(_types_fimlsTypes__WEBPACK_IMPORTED_MODULE_0__["SET_ALL_FILMS"], oldFilms);
    ...
    likedMovie({
      ...
      commit(_types_fimlsTypes__WEBPACK_IMPORTED_MODULE_0__["LIKE_MOVIE"], id);
    },
    moviesILike() {
      let filmFavs = [];
    ...
    changeValueSearch({
      ...
      commit(_types_fimlsTypes__WEBPACK_IMPORTED_MODULE_0__["INPUT_SEARCH"], value);
    },
    async getAllCommentFilm({
      ...
      commit(_types_fimlsTypes__WEBPACK_IMPORTED_MODULE_0__["ERROR_COMMETS"], "");
      commit(_types_fimlsTypes__WEBPACK_IMPORTED_MODULE_0__["LOADING_COMMETS"], true);
      try {
        ...
        commit(_types_fimlsTypes__WEBPACK_IMPORTED_MODULE_0__["SET_ALL_FILMS"], oldFilms);
        commit(_types_fimlsTypes__WEBPACK_IMPORTED_MODULE_0__["LOADING_COMMETS"], false);
      } catch (error) {
        commit(_types_fimlsTypes__WEBPACK_IMPORTED_MODULE_0__["ERROR_COMMETS"], error);
        commit(_types_fimlsTypes__WEBPACK_IMPORTED_MODULE_0__["LOADING_COMMETS"], false);
        return false;
      }
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _types_authTypes__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);

const url = "https://studio-ghilbli-api-production.up.railway.app/api" + "/login";
const store = {
  namespaced: true,
  state: {
    scope: [],
  ...
  actions: {
    setUsername({
      ...
      commit(_types_authTypes__WEBPACK_IMPORTED_MODULE_0__["SET_USERNAME"]);
    },
    logoutAuth({
      commit
    }) {
      commit(_types_authTypes__WEBPACK_IMPORTED_MODULE_0__["LOGOUT_AUTH"]);
    },
    async sign({
      commit
    }, user) {
      commit(_types_authTypes__WEBPACK_IMPORTED_MODULE_0__["LOADING_AUTH"], true);
      commit(_types_authTypes__WEBPACK_IMPORTED_MODULE_0__["ERROR_LOGIN"], "");
      try {
        ...
        if (false) {}
        commit(_types_authTypes__WEBPACK_IMPORTED_MODULE_0__["LOADING_AUTH"], false);
        return true;
      } catch (error) {
        commit(_types_authTypes__WEBPACK_IMPORTED_MODULE_0__["ERROR_LOGIN"], error);
        commit(_types_authTypes__WEBPACK_IMPORTED_MODULE_0__["LOADING_AUTH"], false);
        return false;
      }
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _types_userTypes__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5);
const URL_USER_CREATE = "https://studio-ghilbli-api-production.up.railway.app/api" + "/user";
...
const store = {
  ...
  actions: {
    async userCreate({
      ...
      let objFetch = {};
      commit(_types_userTypes__WEBPACK_IMPORTED_MODULE_0__["USER_LOADING"], true);
      try {
        if (data.type == "PUT") {
          const headers = new Headers();
          if (window.localStorage.getItem("user_sg_token") != null) {
        ...
        if (dataJson.error) {
          ...
          if (data.type == "PUT") {
            ...
            window.localStorage.setItem("user_sg", JSON.stringify({
              name,
              email
            }));
          }
          commit(_types_userTypes__WEBPACK_IMPORTED_MODULE_0__["USER_LOADING"], false);
          return dataJson.message;
        }
      } catch (error) {
        commit(_types_userTypes__WEBPACK_IMPORTED_MODULE_0__["USER_ERROR"], error);
        commit(_types_userTypes__WEBPACK_IMPORTED_MODULE_0__["USER_LOADING"], false);
        return false;
      }
    }
...
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
__webpack_require__(11).default("2986f94e", content, true)
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, "body{margin:0;padding:0;font-family:\"Dosis\",sans-serif;overflow:hidden}", ""]);
// Exports
module.exports = exports;
...
/* harmony import */ var _modules_filmsStore__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(12);
/* harmony import */ var _modules_authStore__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(13);
/* harmony import */ var _modules_userStore__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(14);
...
/* harmony default export */ __webpack_exports__["default"] = (() => new vuex__WEBPACK_IMPORTED_MODULE_1___default.a.Store({
  modules: {
    filmsStore: _modules_filmsStore__WEBPACK_IMPORTED_MODULE_2__["default"],
    authStore: _modules_authStore__WEBPACK_IMPORTED_MODULE_3__["default"],
    userStore: _modules_userStore__WEBPACK_IMPORTED_MODULE_4__["default"]
  }
}));
...
async function setContext(app, context) {
  ...
  if (!app.context) {
    app.context = {
      ...
      base: '/',
      env: {
        "baseUrl": "https://studio-ghilbli-api-production.up.railway.app/api"
      }
    };
    // Only set once
    if (false) {}
...
const _05a8a9fc = () => interopDefault(__webpack_require__.e(/* import() | pages/movie/_id */ 5).then(__webpack_require__.bind(null, 73)));
...
(function updateModules() {
  ...
  resolveStoreModules(__webpack_require__(13), 'modules/authStore.js');
  resolveStoreModules(__webpack_require__(12), 'modules/filmsStore.js');
  resolveStoreModules(__webpack_require__(14), 'modules/userStore.js');
  resolveStoreModules(__webpack_require__(2), 'types/authTypes.js');
  resolveStoreModules(__webpack_require__(1), 'types/fimlsTypes.js');
  resolveStoreModules(__webpack_require__(5), 'types/userTypes.js');
